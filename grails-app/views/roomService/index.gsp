...
-->
    	...
    	<section class="content gradient clearfix">
			...
			<p>
    			Enjoy a bite to eat from our award-winning kitchen sagittis lacus vel augue laoreet rutrum.
    		</p>
    	</section> <!-- /.content -->
		...
		<div data-role="collapsible-set">
			<div data-role="collapsible" data-mini="true" data-iconpos="right" data-theme="q" data-collapsed="false">
				<h3>
					Breakfast Menu
					<div class="h3-sub">Hours 6:00am - 11:00pm</div>
				</h3>
				<ul class="rows alternating">
					<li class="modal clearfix" href="../staticpages/modal-additem.html">
						<div class="label menu-item">Item 1a</div>
						<div class="info menu-item-price">$9.99</div>
					</li>
					<li class="modal clearfix" href="../staticpages/modal-additem.html">
						<div class="label menu-item">Item 2a</div>
						<div class="info menu-item-price">$9,999.99</div>
					</li>
					<li class="modal clearfix" href="../staticpages/modal-additem.html">
						<div class="label menu-item">Item 3a</div>
						<div class="info menu-item-price">$99.99</div>
					</li>
					<li class="modal clearfix" href="../staticpages/modal-additem.html">
						<div class="label menu-item">Item 4a</div>
						<div class="info menu-item-price">$9.99</div>
					</li>
				</ul>
			</div>
			<div data-role="collapsible" data-mini="true" data-iconpos="right" data-theme="q">
				...
				<ul class="rows alternating">
					<li class="modal clearfix" href="../staticpages/modal-additem.html">
						<div class="label menu-item">Item 1b</div>
						<div class="info menu-item-price">$9.99</div>
					</li>
					<li class="modal clearfix" href="../staticpages/modal-additem.html">
						<div class="label menu-item">Item 2b</div>
						<div class="info menu-item-price">$9,999.99</div>
					</li>
					<li class="modal clearfix" href="../staticpages/modal-additem.html">
						<div class="label menu-item">Item 3b</div>
						<div class="info menu-item-price">$99.99</div>
					</li>
				</ul>
			</div>
